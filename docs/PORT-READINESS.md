...
**Execution is active in DIRECT mode.** The [current checkpoint](goals/2026-09-11-godot-full-port.md#current-checkpoint-and-evidence) records native `32d5ef85` and the representative story/cutscene lifecycle matrix. P8-A03 is current.51/68 verified atoms (75.0% by count) is not game readiness.
...
| P8 | A01–A02 verified; A03 in_progress | Complete site ledger has zero unknown reachable behavior; representative story start/fail/retry/skip/complete/cleanup is owned; activity families proceed next |
