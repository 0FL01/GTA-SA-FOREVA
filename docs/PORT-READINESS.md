...
| P9 | A05 verified; A01 in_progress; A02/A03 target-blocked, A04/A06 dependent | Corrected script player now exposes missing source random car-generator selection on the local mission route. Target closure remains open until the Fedora gate genuinely exits0 |
