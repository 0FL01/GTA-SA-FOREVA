...
| P1 | A01–A07 verified | Qualified identities/catalog/chain, paired render/COL, sole-owner async parser, budgeted publication/retirement and catalog-backed exterior/interior residency verified; P2 research is current |
| P2 | A01 in_progress RESEARCH ONLY (no implementation yet) | Minimal C++ authority hosted by Godot |
