...
| P3 | A01–A03 verified; A04 in_progress | Camera ownership/transition trace passes without node feedback; full view solver stays P7-A03. Current: common Automobile exact model/handling/occupant construction |
