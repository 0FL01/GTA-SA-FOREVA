...
| P1 | A01–A07 verified | Qualified identities/catalog/chain, paired render/COL, sole-owner async parser, budgeted publication/retirement and catalog-backed exterior/interior residency verified; P2-A03 verified, P2-A04 semantic research is current |
| P2 | A03 verified; A04 in_progress semantic research ONLY (no implementation) | Minimal C++ authority hosted by Godot |
