...
**Execution is active in DIRECT mode.** The [current checkpoint](goals/2026-09-11-godot-full-port.md#current-checkpoint-and-evidence) records native `308ffe90`, frontend/game/map/settings restoration and P7-A04 next.46/68 verified atoms (67.6% by count) is not game readiness.
...
| P7 | A01–A03 verified; A04 in_progress, joins P4 | Source pose/material plus camera/HUD/radar/frontend lifecycle verified; multilingual GXT/font/substitution families next |
