...
**Execution is active in DIRECT mode.** The [current checkpoint](goals/2026-09-11-godot-full-port.md#current-checkpoint-and-evidence) records native `e82af682` and explicit PC particle/shadow/reflection/post profiles. P7-A10 movies is current; P8-A07 semantic compatibility remains open.57/68 verified atoms (83.8% by count) is not game readiness.
...
| P7 | A01–A05/A07–A09 verified; A06 target-open; A10 current | PC effect profiles verified with explicit differences; non-Dummy target audio and startup movies stay open |
| P8 | A01–A06 verified; A07 open | Site/story/activity/progression, special-state inventory and original-PC block envelope verified; semantic import/export remains open |
