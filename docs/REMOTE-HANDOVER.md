...
**Latest checkpoint:** native `8e1ec020` is pushed; root companion contains this checkpoint. P6-A06 separately recovers death to Hospital and arrest to Police, restoring actor/world/task/area/camera/control/gameplay state at generation2. Direct11 and strict sanitizer pass; native33/0 remains green. Extension/package code stays SHA256 `55bf329e32a775111b06c7055e15e8e2c9f0a04a32c586bb7fa8c49858bbbf47`.
**Current atom:** P6-A07 owns garage/property/shop buy/use/save/reload interaction. Restart selection registration alone was not counted; the verified lifecycle applies all63 source effects. P4-A08 remains dependency-open at strict `0390`. Progress42/68=61.8%, not game readiness.
