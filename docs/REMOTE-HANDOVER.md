...
**Latest checkpoint:** native `c41bf195` is pushed; root companion contains this checkpoint. P6-A05 repeats an offense600→level3→four-cop pursuit→roadblock threshold12→clean escape scenario with identical306-event state journals. Direct927 and strict sanitizer pass; native33/0 remains green. Extension/package code stays SHA256 `55bf329e32a775111b06c7055e15e8e2c9f0a04a32c586bb7fa8c49858bbbf47`.
**Current atom:** P6-A06 owns separate death/arrest restart selection and return-to-play lifecycle. Wanted values compose with prior path/event/combat owners; they do not hide cop movement or combat. P4-A08 remains dependency-open at strict `0390`. Progress41/68=60.3%, not game readiness.
