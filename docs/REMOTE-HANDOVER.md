...
**ACTIVE:** cheap default/costly ambiguity, no fixed count. P1-A04 native95713252 + root companion implement actual paired3991/4043 DFF+122-face COL data; clean Vulkan package/native33/0 pass. A Vulkan-only static/dynamic libstdc++ facet collision was fixed with a single-entry ELF export policy, enforced by packaging. No general physics/full LOD claim. Current atom P1-A05 researches sole-owner parser-worker/cancellation; A06 GPU budgets remain pending. See goal/GODOT-P1-08; historical pause is superseded.
