...
**Latest checkpoint:** P4-A01 at native `9c1aede4`; root companion is the commit containing this checkpoint, based on `53b2ce6`. Pinned schema identity and semantic coverage are separate. Owned corpus classifies the real HUD-ready startup path:1288 sites,43 opcodes,48 exact operand/tag/array forms, two main/mission thread generations, fingerprint `BC61CAB8953E4545`; strict `0814@212669` is decoded15 float+int16 through212749 but remains unexecuted Unsupported. CPU-negative path593/32/36 (`4C8A0CD97C3A3533`) preserves539/0570 as implemented form with unavailable host readiness. Session5467+ASan/UBSan, generated VM4511, frame/startup, native build/smoke/sweep33/0 pass. Extension/package remains byte-identical `6d00c0bef914a5d805c0ab6189b3036f3ea13e1342a17715a02a3f08d8f0c1ca`. P4-A01 is verified:24/68=35.3%, not readiness.
**Active P4-A02:** implement deterministic wait/stack/mission/streamed scheduling needed by startup without a second scheduler, unknown NOP or fake service readiness. The manifest covers only encountered main/mission sites, not all135 missions/79 streamed-script bodies. `0814` owner/runtime, genuine boot/save and all six finish axes remain open.
