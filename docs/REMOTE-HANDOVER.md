...
**Latest checkpoint:** native `679336e0` is pushed; root companion contains this checkpoint. All five shipped GXT files expose identical127-table families; direct83,025 checks resolve all82,997 hash entries plus number/string/control substitutions and actual font1/font2 atlas paths. SDL-dummy MenuNav renders translated MAIN text in all five languages. Strict sanitizer, full builds, smoke and sweep33 pass; extension/package SHA256 remains `afe27781b7e8161e0656c05a82581817b6da11d18891917bb503979adb1592da`.
**Current atom:** P7-A05 owns complete keyboard/mouse/controller binding, hotplug and feedback behavior. P7-A04 closes at47/68=69.1%; P4-A08 remains dependency-open at strict `0390`. This is not game readiness.
