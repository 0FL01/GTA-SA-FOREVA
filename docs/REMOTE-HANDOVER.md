...
**Latest checkpoint:** native `72315602` is pushed; root companion contains this checkpoint. The fixed202752-byte original-PC envelope codec covers all28 ordered `BLOCK` payloads, exact additive checksum/zero padding and atomic int32 reference repair. Direct37, sanitizer, related persistence regressions, builds/smoke/sweep33 pass. Extension/package remains `980cb6a251fd0a7fc3500a9249873088e501fd521a25966f7dddccad3a29bad6`.
**Current atom:** P8-A07 semantic original-PC import/export compatibility.55/68 verified (80.9%), not readiness. P8-A06 treats block payloads as opaque codec inputs; no original-save compatibility claim exists before the fresh-process semantic route. Explicit Pending special states, P4-A08 and P7-A06 remain open.
