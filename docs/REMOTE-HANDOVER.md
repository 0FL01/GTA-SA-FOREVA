...
**Latest checkpoint:** native `6dd454b7` is pushed; root companion contains this checkpoint. `--new-game --boot-gate` completes source mission0 and mission2 and exits0 with control1/fade0/no-fault at script position2232.000,-1382.251,23.554. This verifies P4-A06; progress is29/68=42.6%, not readiness.
**Active P4 boundary:** P4-A07 is in progress. The route owns source car-recording interpolation, GXT text, mission-audio duration clocks, world/model/COL handoff, mission vehicles/peds and cleanup, but does not yet present source cutscene camera/models, NPC pose/AI, train movement or beat/mission-audio output. Focused peds9/audio/carrec7/beat8/trains5, Session5482/scheduling106/frame104/transaction71/portable111, sanitizers and native33/0 pass; extension remains `acf7d35b3f433e1d4323fc8c1357062408a0c67292223764654a33c9b30bdb0c`.
