...
**Latest checkpoint:** native `6d47af4f` pushed; root companion based on `3181d42`. Source task-slot/tree ownership passes50 direct/sanitized checks, including nested transitions and actual jump-clump teardown; clump38/jump75/frame104/session5451 regressions pass. Extension is unchanged `02b4434f095028c084351cb700a7f27cd9c3f591c0b7b21b6039b74ff7ad14b2`; previous clean Vulkan actor/region/async evidence remains applicable. Next is idle/start/stop locomotion integration; A01 stays open, count16/68. Full evidence/commands in the [single current checkpoint](goals/2026-09-11-godot-full-port.md#current-checkpoint-and-evidence) and Godot README.
