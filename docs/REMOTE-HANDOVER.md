...
**Latest checkpoint:** native `1a25c083` is pushed; root companion contains this checkpoint. P6-A02 owns capacity-bounded producer/group/event flow and reproduces source script/ordinary priority tie rules in an identical twice-run seven-transition route. Direct25 and strict sanitizer pass; native33/0 remains green. Extension/package code stays SHA256 `55bf329e32a775111b06c7055e15e8e2c9f0a04a32c586bb7fa8c49858bbbf47`.
**Current atom:** P6-A03 owns actual moving traffic/ped spawn/removal under forced pool pressure; parked definitions alone cannot pass. Typed scanner events remain caller-supplied and do not claim address-backed perception. P4-A08 remains dependency-open at strict `0390`. Progress38/68=55.9%, not game readiness.
