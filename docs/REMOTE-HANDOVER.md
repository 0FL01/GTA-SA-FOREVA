...
**ACTIVE DIRECT:** native `693d2a19` is pushed; root companion contains this checkpoint.61/68 verified (89.7%), not readiness. User's Fedora target passed individual audio/render/package checks but failed the mission at `0340` with invisible 2-triangle CJ; full target closure and interactive Big Smoke are NOT passed. Source uint8 text ABI, real modular CJ at `070D` and scripted passenger position/pose are locally fixed/tested; current long server mission exits1 at a newly exposed random car-generator source zone/AppropriateLoadedCars/RNG demand, not at `0340`. No fixed model fallback or fake Ready. P0-A04/P7-A06/P9 target acceptance remain external while P9-A01 has actionable local work.
