...
**Latest checkpoint:** native `3befe10a` is pushed; root companion contains this checkpoint. Normal `--new-game --first-mission-gate` completes mission2 with camera9/text936/cleared cutscene/completed audio clock/stopped beat/deleted trains plus control1/fade0/no-fault. P4-A07 is verified; progress is30/68=44.1%, not readiness.
**Active P4 boundary:** P4-A08 is in progress: prove first-mission start/fail/retry/complete and matching pre/post portable-save restart/load semantics. Owner evidence is value-only (`presentation-feedback=0`); final cutscene/NPC/train/audio presentation remains P7/P6. Focused peds9/audio/carrec7/beat8/trains5, Session5482/scheduling106/frame104/transaction71/portable111, sanitizers and native33/0 pass; extension remains `acf7d35b3f433e1d4323fc8c1357062408a0c67292223764654a33c9b30bdb0c`.
