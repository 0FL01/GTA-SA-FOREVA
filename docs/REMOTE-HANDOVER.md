...
**Latest checkpoint:** native `88fdffcf` is pushed; root companion contains this checkpoint. Exact door SFX80/138/40, mission speech43200 and rain105/0 payloads reach Godot AudioStreamWAV/Ogg and all three players start under Dummy CI with lengths0.281/25.158/2.751. Direct7+sanitizer, full builds, smoke/sweep33 pass. Extension/package SHA `980cb6a251fd0a7fc3500a9249873088e501fd521a25966f7dddccad3a29bad6`.
**Current atom:** P7-A06 remains open only for the required non-Dummy target Godot audio run; this container exposes Dummy and the target-required route fails explicitly rather than claiming audible output. P7-A07 radio programming/playback proceeds independently. Verified count remains48/68; P4-A08 remains strict at0390.
