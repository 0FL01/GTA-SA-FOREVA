...
**Latest checkpoint:** native `8faf5bee` is pushed; root companion contains this checkpoint. A fresh-process E2E performs mission2 skip/fail/cleanup/retry/complete/cleanup, persists post-progress and verifies it in a second restarted reader. Story18, progression12, portable111 and mission-audio source/direct-ID routes pass.
**Current atom:** P9-A01 finish-line audit;59/68 verified (86.8%), not readiness. P4 is now complete. P7-A06 target audio, P7-A10 startup movie codec/license path, P0 target reflight and P9 release closure remain open.
