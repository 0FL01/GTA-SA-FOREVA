...
**ACTIVE:** cheap default/costly ambiguity, no fixed count. P2-A03 device-input edge seam verified; native `47c5c109` pushed, root companion is the commit containing this checkpoint, based on `5d9ac72`. Core keeps explicit `04E4` collision frontier (`ip=56022 next=56034`), exit0 fixture success not boot; existing native Host main53/mission1234/0814 frontier stays separate — neither is full boot. Extension SHA256 NEW `bf3b7a019a5f90aa4d6c14523a5366e28f615b41f5674afb73c1d835d9c1b735` (ONLY `NativeSourcePad.cpp.o` into `sa_legacy`, sole `sa_legacy_library_init` export); existing native product unchanged. Current P2-A04 is in_progress semantic research ONLY (no implementation). See goal checkpoint/history and journal GODOT-P2-14; historical pause is superseded.
