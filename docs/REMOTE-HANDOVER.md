...
**Latest checkpoint:** P3-A01 integrated ordinary on-foot/jump/interruption boundary verified; native `45f192a4` pushed, root companion is the containing commit (base `0c2a9a3`).294 integrated,57 manager and107 real-bank checks pass, including all-relevant-source task/manager ASan/UBSan. Shared COL face-group metadata changes extension SHA256 to `d35fe301e59cd40a367ab74eea3bb60ca6f36cf6ef9ca3c28827393b89de0f48`; fresh clean Vulkan actor/region/async and native33/0 sweep pass. Special control branches remain explicit, not ordinary-run substitutes; synthetic contact observations are not physics. Count17/68, not game readiness. Evidence/commands in the [single current checkpoint](goals/2026-09-11-godot-full-port.md#current-checkpoint-and-evidence) and Godot README.
