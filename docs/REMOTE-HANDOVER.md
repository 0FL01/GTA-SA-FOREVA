...
**Latest checkpoint:** P3-A03 mode/target transition owner at native `0034e04d`; root companion contains this checkpoint (base `3975fdd`). Source FollowPed4/CamOnAString18 identities, direct-behind and1350/800ms transitions publish immutable input-qualified events; core72 + ASan/UBSan and matching registered Godot value trace pass with `presentation_feedback=false`. Core25 TUs; extension NEW `de50c7832e75943827f00a97b2554fe0f561ec20ac749434ba17c1caf2b4e568`. A03 remains in_progress because source FollowPed/FollowCar view/world-collision bodies remain Unsupported; diagnostic orbit is not authority.18/68=26.5%, not readiness. All six axes and target reflight remain open.
