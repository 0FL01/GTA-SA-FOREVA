...
**Latest checkpoint:** native `470e326e` is pushed; root companion contains this checkpoint. P6-A03 moves source model400 traffic and model7 peds on real Grove graph routes, then proves source threshold/frame-gated closest cleanup at103→102 vehicles and133→132 peds. Direct248 and strict sanitizer pass; native33/0 remains green. Extension/package code stays SHA256 `55bf329e32a775111b06c7055e15e8e2c9f0a04a32c586bb7fa8c49858bbbf47`.
**Current atom:** P6-A04 owns weapons/projectiles/fire/damage across representative source classes. Population values are moving graph consumers, not parked definitions, but presentation and broad behavioral AI remain later. P4-A08 remains dependency-open at strict `0390`. Progress39/68=57.4%, not game readiness.
