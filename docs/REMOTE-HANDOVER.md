...
**Latest checkpoint:** native `96b8b7e2` pushed; root companion based on `a39cbef`. Ordinary idle/start/walk/run/stop association flow passes25 direct/sanitized checks and53 real-bank checks; tasks50/jump75/clump38 regressions pass. Extension unchanged `02b4434f095028c084351cb700a7f27cd9c3f591c0b7b21b6039b74ff7ad14b2`; clean Vulkan actor/region/async evidence remains applicable. Next: integrated on-foot/jump bodies and delivery of animation events to inactive tasks. Special sprint/exhaustion/turn/adrenaline branches remain explicit, not ordinary-run substitutes. A01 stays open, count16/68. Evidence/commands in the [single current checkpoint](goals/2026-09-11-godot-full-port.md#current-checkpoint-and-evidence) and Godot README.
