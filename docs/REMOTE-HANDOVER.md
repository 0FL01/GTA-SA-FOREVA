...
**Latest checkpoint:** native `c1e74703` is pushed; root checkpoint commit follows. P4-A06 directly owns the bounded mission object/generator service slice and the real `/game` startup now reaches strict `09E2@221414` after `014C@221407`, mission commands1612, executed76. Focused objects10/session5472/scheduling106/frame104, native smoke and container etalon sweep33/0 pass. This is `28/68=41.2%`, not readiness; no ASan/UBSan claim is made for this new owner set.
**Paused P4-A06 boundary:** object full matrix/render/world cleanup, near garage source type/state body, plate-generator construction/pool fulfillment, mission wait/termination and controllable play remain strict. The old six-capture boot oracle is historical for the pre-A06 frontier; use the current checkpoint/log for the continuation. Do not claim genuine boot, original PC save compatibility or a complete gameplay save. All six finish axes remain open.
