...
**Latest checkpoint:** P3-A05 common Automobile control/contact at native `872cab94`; root companion contains this checkpoint (base `37d0177`). Exact model400 `landstal` uses actual IDE/DFF/TXD/embedded `landstal_col`18-sphere/10-face and `LANDSTAL` handling state for controls, transmission, DFF suspension, wheel response and bounded static-building collision. General two-sided ProcessColModels11 and Automobile107 pass direct+ASan/UBSan/leak; native33/0, read-only/no-EXE trace, byte-identical diagnostic trace and fresh clean-package camera/actor/region Vulkan routes pass. Extension `1272aeca12ae5fb0cc952603e291664b3fb01af3d2da2beed5a288be3d2401bd`; PID1 docker-init/zombies0. This verifies A05:21/68=30.9%, not readiness.
**Active P3-A06:** complete actual spawn -> enter -> drive -> exit -> destroy lifetime across existing pools and streaming eviction. Do not promote `RealtimeGameplay`/diagnostic actor authority. A05 deliberately excludes world discovery, dynamic vehicle/object response, damage/effects/audio/RNG, all family control and Godot gameplay hosting. All six axes and target reflight remain open.
