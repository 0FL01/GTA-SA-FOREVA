...
**Latest checkpoint:** native `f735a739` is pushed; root companion contains this checkpoint. `NativeInputLifecycle` composes keyboard/mouse/gamepad into source pad sampling with34 bindings, stale-safe hotplug generations and value feedback requests. Direct17+sanitizer pass; actual SDL3 virtual-gamepad feedback/hotplug probe has zero failures, and packaged Godot `_input()` trace still matches11 source rows. Full builds, smoke and sweep33 pass; extension/package SHA256 remains `afe27781b7e8161e0656c05a82581817b6da11d18891917bb503979adb1592da`.
**Current atom:** P7-A06 owns SFX, speech and environmental audio with real target Godot output; Dummy remains CI-only. P7-A05 closes at48/68=70.6%; P4-A08 remains dependency-open at strict `0390`. This is not game readiness.
