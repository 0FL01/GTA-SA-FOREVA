...
**Latest checkpoint:** native `e82af682` is pushed; root companion contains this checkpoint. Explicit PC-profile values cover additive particles, alpha shadows, MatFX reflections and the two-pass colour filter. Direct11, strict sanitizer, builds/smoke/sweep33 pass; existing clean material/cloud routes retain actual asset-render evidence. Extension/package remains `980cb6a251fd0a7fc3500a9249873088e501fd521a25966f7dddccad3a29bad6`.
**Current atom:** P7-A10 startup movies;57/68 verified (83.8%), not readiness. Generic FX systems, projected shadow geometry, water reflections/refraction and PS2-only effects are explicit approved differences, not claimed parity. P8-A07 semantic original-save compatibility, explicit Pending special states, P4-A08 and P7-A06 remain open.
