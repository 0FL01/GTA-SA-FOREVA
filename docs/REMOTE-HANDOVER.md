...
**Latest checkpoint:** native `aa26ec24` is pushed; root companion contains this checkpoint. `NativePoseFamilies` and standalone `SALegacyPose` publish copied source ped/IFP and hi-poly cutscene/ANPK poses without Godot feedback. Direct12, strict sanitizer, the132-pose CJ oracle, native33/0 and clean packaged Forward+ pose/catalog/chain/async/actor gates pass. Extension/package SHA256 is `9dee44117cb6f3a9a04d7903f4b58db1c3d6e88ae26020a75ab4fa3c53c8c505`.
**Current atom:** P7-A02 owns source material families, MatFX, mip and alpha pixel behavior. P7-A01 closes at44/68=64.7%; pose rendering is deliberately unshaded diagnostic output, not original material parity. P4-A08 remains dependency-open at strict `0390`. This is not game readiness.
