...
**Latest checkpoint:** P4-A03 at native `3f81349c`; root companion is the commit containing this checkpoint, based on `d71483a`. Pure pointer-free owner/attempt tickets separate worker Pending/Prepared from script Ready. Cancel attempt1 notifies once and requires exact acknowledgement; same-ID retry uses attempt2, stale results reject and publication/journal commit once. The71-check pure+Session gate, real resident-world host cancel/retry, invalid/throwing Prepared rejection, actual parser-worker placement/cleanup, ASan/UBSan, strict startup fingerprints, native smoke/sweep33/0 pass. Extension/package remains `6d00c0bef914a5d805c0ab6189b3036f3ea13e1342a17715a02a3f08d8f0c1ca`. P4-A03 verified:26/68=38.2%, not readiness.
**Active P4-A04:** define owner serialization contracts and an early versioned portable save envelope, then prove a restarted-process owned graph and strict truncation/version rejection. This is not original PC save compatibility. Generated scheduler/service fixtures do not claim every streamed body, `0814`, genuine boot or mission/save completion; all six finish axes remain open.
