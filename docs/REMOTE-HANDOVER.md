...
**Latest checkpoint:** native `d72a417c` is pushed; root companion contains this checkpoint. Complete native mip chains and actual Landstal MatFX/alpha metadata reach immutable source scenes and Godot materials. Actual census20 none/97 env,930 env triangles and `xvehicleenv128`; isolated Forward+ env/mip/alpha pixels, strict sanitizer, native material GPU oracle, smoke/sweep33/0 and pose/actor/catalog/chain regressions pass. Extension/package SHA256 is `a6ddb65bf2b34558f8be5955e0b7b4cb28d50345603be23ae895cd9290ef27c9`.
**Current atom:** P7-A03 owns complete camera/HUD/radar/map/frontend/settings lifecycle. P7-A02 closes at45/68=66.2%; only discovered none/env and opaque/cutout/blend plus authored mip behavior are claimed, not unseen MatFX or original-reference parity. P4-A08 remains dependency-open at strict `0390`. This is not game readiness.
