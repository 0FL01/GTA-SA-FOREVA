...
**PAUSED checkpoint:** native `1a6fa9a5` is pushed; root companion contains this checkpoint. Mission0 terminates; mission2 now owns exact car-recording/beat metadata, sole-worker model/world handoff, a real-COL mission vehicle and generation-safe mission-ped occupancy. The latest measured run reached `067F@202178`; committed code fixes its source light enum0..2 and compiles typed `0430/0129`, which need the next long runtime reflight.
**Active P4 boundary:** P4-A06 remains in progress at28/68 because fade-clear/live exit0 is not proven. Focused builds, smoke, peds6/carrec4/beat7, Session5472/scheduling106/frame104/transaction71 pass; extension hash remains `acf7d35b3f433e1d4323fc8c1357062408a0c67292223764654a33c9b30bdb0c`, package not regenerated. Resume at the exact runtime reflight; do not treat retained car-recording/cutscene/actor values as playback, camera/audio/model presentation, NPC AI or cleanup. All six finish axes remain open.
