...
**Latest checkpoint:** native `2d96815f` is pushed; root companion contains this checkpoint. P6-A07 buys/uses a property, garage and shop, round-trips ownership/progression through a versioned checksum envelope, then continues after restart while rejecting corruption. Direct11 and strict sanitizer pass; native33/0 remains green. Extension/package code stays SHA256 `55bf329e32a775111b06c7055e15e8e2c9f0a04a32c586bb7fa8c49858bbbf47`.
**Current atom:** P7-A01 owns source skins, animation families and cutscene poses. P6 closes at43/68=63.2%; storefront/garage rendering and original PC-save integration remain P7/P8. P4-A08 remains dependency-open at strict `0390`. This is not game readiness.
