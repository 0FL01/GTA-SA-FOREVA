...
**Latest checkpoint:** native `308ffe90` is pushed; root companion contains this checkpoint. Immutable frontend screen/settings/map state composes source camera ownership. Direct11 and packaged Godot route complete frontend→game→map→settings→game with13 events and exact state restoration; camera72, HUD/radar GPU, event-queue GXT/font menu navigation, strict sanitizer, smoke/sweep33 pass. Extension/package SHA256 `afe27781b7e8161e0656c05a82581817b6da11d18891917bb503979adb1592da`.
**Current atom:** P7-A04 owns complete MAIN/mission multilingual GXT, source fonts and substitutions. P7-A03 closes at46/68=67.6%; the still-unreversed eye/collision solver remains unsupported, never Godot-authored. P4-A08 remains dependency-open at strict `0390`. This is not game readiness.
