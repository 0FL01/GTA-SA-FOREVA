...
**Latest checkpoint:** native `e318ef20` is pushed; root companion contains this checkpoint. Mission0 terminates, main continues and real mission2 reaches strict `07C0` after actual streamed/static/special model packets, PROLOG1 cutscene archive/timing and a generation-qualified directional world handoff. New owner probes, Session5472 ASan/UBSan, scheduling106/frame104/transaction71/portable111, native33/0 and clean package actor/region gates pass. Extension/package SHA256 is `acf7d35b3f433e1d4323fc8c1357062408a0c67292223764654a33c9b30bdb0c`.
**Active P4 boundary:** P4-A06 is still in progress at28/68 because fade-clear/live exit0 is not yet proven; P4-A07 car-recording/playback and complete cutscene camera/audio/model presentation are not implemented. Continue from `07C0 REQUEST_CAR_RECORDING`; do not weaken it to Ready or treat retained archive/timer state as presentation. All six finish axes remain open.
