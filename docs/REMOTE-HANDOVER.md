...
**Latest checkpoint:** native `ebb5c335` is pushed; root companion contains this checkpoint. P5-A01 verifies actual Grove321→interior16-36 residency with complete ordered placement identity, paired source-COL/request generation, all64 validated source path files and a stable dynamic reference. Direct19 + sanitizer, core-world79, native33/0 and clean Forward+ catalog/chain/async gates pass. Extension/package SHA256 `9891d1b8a422c98b813266b5251fbfcc3e8867c1e039fcb546e0463fc412298c`.
**Current atom:** P5-A02 owns runtime LOD/time-object/interior visibility; P5-A01 explicitly has `PathSearchAuthority=false` because P6-A01 owns graph search. P4-A08 remains dependency-open at strict `0390 LOAD_TEXTURE_DICTIONARY LD_NONE`; do not fake `0390/038F` Ready or infer presentation from value-only owners. Progress31/68=45.6%, not readiness.
