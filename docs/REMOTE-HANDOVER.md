...
**Latest checkpoint:** P3-A07/P3 stage closure at native `519e68e1`; root companion is the commit containing this checkpoint, based on `1061cc4`. The115-check route consumes genuine `NativeSourcePad`, parser-worker model400 Landstal and real3991/122-face source COL, then publishes14 lifecycle/action observations, source-initial HUD and four task-qualified exact NEW-door PCM events:80/86, bank138/slot19, sounds40/33. Direct+full-path ASan/UBSan, native33/0, real OpenAL SFX smoke, read-only/no-EXE and fresh package Vulkan routes pass. Extension/package `6d00c0bef914a5d805c0ab6189b3036f3ea13e1342a17715a02a3f08d8f0c1ca`; PID1 docker-init/zombies0. P3 is verified:23/68=33.8% equal atoms, not readiness.
**Active P4-A01:** build the shipped startup corpus/schema manifest with complete encountered operand/thread forms while preserving strict main53/mission1234/0814 and CPU539/0570 history. Unknown commands remain terminal; no NOP/fake Ready. Complete door task bodies/Godot gameplay scene, mutable full HUD and mixer/spatialization remain later P4/P7 work. All six finish axes and target reflight remain open.
