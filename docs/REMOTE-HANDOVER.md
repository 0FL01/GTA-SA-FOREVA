...
**Latest checkpoint:** P3-A04 exact common Automobile constructor at native `8e5b1e3a`; root companion contains this checkpoint (base `5e837e0`). Actual model400 `landstal` IDE/DFF/TXD/embedded-COL and `LANDSTAL` handling construct immutable source state with DFF-derived passenger capacity and exact occupant identities. Direct44 + ASan/UBSan/leak, camera72/ped-world84/tasks294/IFP107, byte-identical diagnostic trace and native smoke pass. No400/476 fallback. This verifies A04 only:20/68=29.4%, not readiness; no pool/world/control/collision/Godot driving claim. P3-A05 Automobile control/Physical integration is in_progress. All six axes and target reflight remain open.
**Active P3-A05 subcheckpoint:** native `2daa4602` through wheel/contact follow-ups owns all35 handling fields, ordinary controls, source transmission/air resistance, DFF-derived suspension, grounded wheel traction/force states and bounded ordered contact provenance; direct+ASan/UBSan fixture75 passes. A05 remains in_progress: contact response/integration against real source COL is not implemented; fixture contacts are not detection.
