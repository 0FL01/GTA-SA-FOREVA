...
**Latest checkpoint:** native `f5e4d07f` is pushed; root companion contains this checkpoint. P6-A04 parses71 shipped weapon rows and proves ped/vehicle/object instant-hit, projectile, fire, armour, damage and death transitions. Direct15 and strict sanitizer pass; native33/0 remains green. Extension/package code stays SHA256 `55bf329e32a775111b06c7055e15e8e2c9f0a04a32c586bb7fa8c49858bbbf47`.
**Current atom:** P6-A05 owns wanted escalation, pursuit, roadblocks and escape. Combat state is authoritative value ownership; effects/audio and melee combo damage remain downstream source consumers. P4-A08 remains dependency-open at strict `0390`. Progress40/68=58.8%, not game readiness.
