...
**Active P3-A05 subcheckpoint:** native `c74cc5e6` after `aaa5f542`/`abbb6545` owns all35 relevant handling fields, ordinary keyboard control, existing source transmission/air resistance and four suspension lines from actual wheel dummy positions; direct+ASan/UBSan fixture67 passes. A05 remains in_progress: wheel force/traction response and source vehicle contacts are not implemented.
