...
**Latest follow-up:** native `c3bea960` pushed; root companion contains this checkpoint (base `6163cf1`). Retail ped collision-step planner now passes44 physical checks with full-source ASan/UBSan; source minimums, NPC elasticity and uint8 narrowing preserved. Model26/contact315 regressions and coherent build pass; extension unchanged from the fresh delivery below. Logs `p3-ped-steps-*`. P3-A02 remains open for the actual collision driver/support/world route.
