...
**ACTIVE:** cheap default/costly ambiguity, no fixed count. P1-A06 budgeted publication/retirement verified; root companion containing this checkpoint, based on `4ea8d9e`; native remains 95713252. Quota work-item budgets (budget1 fixture quota1/cap16; production default quota64/cap256), two-root commit, one retiring generation, weakref-proven hidden-stage retirement; sync/teardown unbudgeted. Final 40s route is lifecycle-only (ready 0/submit 7/cancel 7, Grove retained). Current P1-A07 is semantic research selected, no implementation yet. See goal/GODOT-P1-10; historical pause is superseded.
