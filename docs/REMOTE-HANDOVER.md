...
**ACTIVE, DIRECT AT USER REQUEST:** no subagents; no compress unless critical; parent performs RECON/code/tests. P3-A01 source primitives now in native `0216bb70` (pushed):107 control +52 jump checks, full-source sanitizers, frame104/session5451 pass. A01 remains open for task-slot/clump ownership and idle/start/stop flow. Owned game is `Grand-Theft-Auto-San-Andreas/` here, mounted `/game:ro`; static retail RE mapped SetRealMoveAnim to0x627780, not upstream0x60A9C0. Runtime never reads EXE. Extension is byte-identical to verified P2-A06 `2c9dfb65f8179439c73966c9efcb3d8abed45ff9235bec28de424c62570be959`; that studio remains an approximation, not source gameplay. Read the [single current checkpoint](goals/2026-09-11-godot-full-port.md#current-checkpoint-and-evidence).16/68 atoms verified, not game readiness.
