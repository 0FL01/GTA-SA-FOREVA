...
**Latest checkpoint:** native `67bd2db6` is pushed; root companion contains this checkpoint. Mission3 `LD_NONE` is decoded on the sole parser worker into24 owned sprite images and routed through exact Pending/Ready service identity. Direct30, Session5482, scheduling106, native smoke and sweep33 pass. The realtime uploader regression for complete mip chains is fixed.
