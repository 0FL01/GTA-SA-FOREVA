...
**Latest checkpoint:** native `0d1f78f5` pushed; root companion based on `a2c4994`. Shared clump ownership and jump callback integration pass control107/jump75/clump38/real-bank45, sanitizers, frame/session, native smoke and fresh clean Vulkan actor/region/async gates. Extension SHA256 `02b4434f095028c084351cb700a7f27cd9c3f591c0b7b21b6039b74ff7ad14b2`. Next is source task slots and idle/start/stop flow; A01 stays open, count16/68. Full evidence/commands in the [single current checkpoint](goals/2026-09-11-godot-full-port.md#current-checkpoint-and-evidence) and Godot README.
