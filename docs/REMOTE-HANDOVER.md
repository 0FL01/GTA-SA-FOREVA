...
**Latest checkpoint:** native `894971fd` is pushed; root companion contains this checkpoint. All92 cheats,20 replay packet types and9 script special-state families have implemented or explicit Pending rows; bounded cheat/replay/state routes pass31 checks plus sanitizer/build/smoke/sweep33. Extension/package remains `980cb6a251fd0a7fc3500a9249873088e501fd521a25966f7dddccad3a29bad6`.
**Current atom:** P8-A06 original-PC save block codecs.54/68 verified (79.4%), not readiness. Explicit Pending special states, P4-A08 and P7-A06 remain open.
