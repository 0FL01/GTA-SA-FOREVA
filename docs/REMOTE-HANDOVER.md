...
**ACTIVE:** cheap default/costly ambiguity, no fixed count. A05 root companion adds one C++ parser worker, explicit request/epoch cancellation, join-before-Shutdown and async movement/F6; CPU barrier/real-data/clean Vulkan package/normal-route gates pass. Native remains95713252. A04 paired3991/4043 DFF+122-face COL and single-entry ELF export isolation remain intact; no general physics/full LOD claim. Current P1-A06 researches budgeted main-thread conversion/retirement; initial loads and GPU conversion still block. See goal/GODOT-P1-09; historical pause is superseded.
