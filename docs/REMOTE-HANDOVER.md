...
**Latest checkpoint:** native `53f4d699` is pushed; root companion contains this checkpoint. Seventeen discovered service/race/school/minigame/other families each pass a normal start/result/cleanup route; shipped streamed identities are exact. Direct114+sanitizer, builds, smoke and sweep33/0 pass. Extension/package remains `980cb6a251fd0a7fc3500a9249873088e501fd521a25966f7dddccad3a29bad6`.
**Current atom:** P8-A04 persistent purchases/stats/rewards/unlocks/interiors.52/68 verified (76.5%), not readiness. P4-A08 remains strict at mission3 `0390`; P7-A06 requires non-Dummy target audio. Activity lifecycle ordering does not fabricate individual gameplay rules.
