...
- **Versions:** native `45f192a4` committed/pushed; root companion is the commit containing this checkpoint, based on `0c2a9a3`. P3-A02 remains in_progress after the verified model-query seam; this is not complete ped/world physics.
